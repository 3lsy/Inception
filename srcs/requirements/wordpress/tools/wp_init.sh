...
EOF
	...
	wp-cli core install --url=$DOMAIN_NAME/wordpress --title=Inception --admin_user=$WP_ADMIN --admin_password=$WP_ADMIN_PWD --admin_email="$WP_ADMIN_MAIL" --allow-root --path=/var/www/html/wordpress
